...
@interface PhotoEdittViewController ()
    ...
    if(pinGesture.state == UIGestureRecognizerStateBegan || pinGesture.state == UIGestureRecognizerStateChanged){
        ...
        if(ration>_scaleRation){
            ...
            view.frame = newFrame;
                 ...
                 self.OriginalFrame.size.width <= self.OriginalFrame.size.height){
            ...
            view.frame = [self handleScale:view];
                ...
                self.OriginalFrame.size.height <= self.OriginalFrame.size.width){
